...
import { ArrowLeft, Calendar, ChevronDown, Target, Trash2, Trophy, Users, X } from 'lucide-react';
		...
		<section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
			...
			<div className="mt-6 grid gap-5 text-center">
				<div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4">
					...
					<div>
						<p className="text-3xl font-bold text-ink">{match.playerOneScore ?? '-'} - {match.playerTwoScore ?? '-'}</p>
