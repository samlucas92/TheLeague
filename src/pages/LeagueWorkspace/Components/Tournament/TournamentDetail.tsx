			...
			<article className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
				...
				<div className="border-b border-slate-200 px-4">
					<div className="flex gap-6 overflow-x-auto text-sm font-semibold">
						<span className="border-b-2 border-ink py-3 text-ink">Bracket</span>
				...
				<div className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_18rem]">
					...
					<aside className="grid content-start gap-4">
						<SideCard title="Next match">
							{nextMatch ? <NextMatchLarge match={nextMatch} memberNames={memberNames} /> : <p className="text-sm text-slate-600">No scheduled match.</p>}
						</SideCard>
