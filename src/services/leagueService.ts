...
import type { Challenge, JoinPreview, League, LeagueSummary, LeaderboardRow, Member, PointsFeedItem, PublicLeagueView, Submission } from './types';
...
export const leagueService = {
	...
	addPoints: (leagueId: string, input: { leagueMemberId: string; points: number; reason: string }) =>
		postJson(`/leagues/${leagueId}/allocations`, input),
